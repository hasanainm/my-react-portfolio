...
const AboutMe = () => {
  return (
    <div className="row u-margin-top-big u-margin-bottom-big">
      <div className="col-1-of-2 u-left-text bio">
        ...
        <hr className="line"/>
        <p className="u-margin-top-tiny heading-primary--bio">My name is Hasanain Mohammed and I am a Full-Stack Web Developer. I'm also a UH Cougar, Houstonian, and an tech-enthusiast. With a background in MIS, I'm interested in solving business probelems with technologies. As the tech community continues to grow, I'm constantly asking myself what new technologies are emerging and how can we utilize them to improve business processes. This has inspired and emboldened me to learn and implement various concepts of software and web development.</p>
      </div>
